...
Vagrant.configure('2') do |config|
  ...
  config.vm.define 'router' do |router|
    ...
    router.vm.network 'private_network', mac: '000db94bf849', virtualbox__intnet: 'lan'
    router.vm.network 'private_network', mac: '000db94bf84a', virtualbox__intnet: 'lan'
  ...
  config.vm.define 'client1' do |client1|
    ...
    client1.vm.network 'private_network', virtualbox__intnet: 'lan'
  ...
  config.vm.define 'client2' do |client2|
    ...
    client2.vm.network 'private_network', virtualbox__intnet: 'lan'
